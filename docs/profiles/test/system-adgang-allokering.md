# Test af system adgang allokering

## System adgang allokering
```
Som en adgangstildeler har jeg behov for at kunne allokere adgange til en medarbejder
Så rettigheder kan provisioneres via AD til systemet.
```
```
Givet en eksisterende system profil Fasit
Og tilhørende grupper i AD
Og en medarbejder uden adgange til Fasit
Når jeg starter processen 'System Adgang Allokering'
Så kan jeg vælge en medarbejder
Og tildele adgangen 'Fasit' og vælge alle adgange
...
```
Som en administrator har jeg behov for at kunne redigere
